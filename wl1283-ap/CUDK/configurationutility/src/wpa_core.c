...
S32 WpaCore_SetCcx(THandle hWpaCore, U16 CcxConfig)
{
    ...
    pWpaCore->WpaSupplParams.ccx = CcxConfig;
...
#ifdef CCX_MODULE_INCLUDED
       if((pWpaCore->WpaSupplParams.ccx == OS_CCX_CONFIGURATION_ENABLE_CCKM)||(pWpaCore->WpaSupplParams.ccx == OS_CCX_CONFIGURATION_ENABLE_ALL))
       {
