...
#define TX_CTRL_FLAG_LINK_TEST             0x0004  /* CCX link test packet */
...
/*	0x1C	*/  TWD_RSN_CCX_SW_ENC_ENABLE_PARAM_ID,				/**< */
/*	0x1D	*/  TWD_RSN_CCX_MIC_FIELD_ENABLE_PARAM_ID,			/**< */
...
typedef struct 
{
    ...
    TI_UINT8                            numOfProbRqst;	/**< This field indicates the number of probe requests to send per channel, when active scan is specified 
														* Note: for CCX measurement this value should be set to 1
														*/
