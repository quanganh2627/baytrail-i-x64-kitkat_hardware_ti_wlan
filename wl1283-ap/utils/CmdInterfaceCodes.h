...
typedef enum
{
    ...
    CCX_MANAGER_MODULE_PARAM        	= 0x1000,	/**< CCX Manager Module Number 						*/
...
*/
    ...
    RSN_DEFAULT_KEY_ID								=	SET_BIT | GET_BIT | RSN_MODULE_PARAM | 0x09,							/**< Robust Security NW (RSN) Defualt Key ID Parameter (RSN Module Set/Get Command): \n  
																																...
																																* SET Bit: ON	\n
																																*/
	RSN_CCX_NETWORK_EAP								=	SET_BIT | GET_BIT | RSN_MODULE_PARAM | 0x0A,							/**< Robust Security NW (RSN) CCX NW EAP Parameter (RSN Module Set/Get Command): \n  
                                                                                                                                * Used for setting/getting RSN CCX NW EAP to/from RSN Module\n
                                                                                                                                * Done Sync with no memory allocation\n 
	...
	/* CCX */    
    CCX_CONFIGURATION							=	SET_BIT | GET_BIT | CCX_MANAGER_MODULE_PARAM | 0x01,	/**< CCX Manager Configuration Parameter (CCX Manager Module Set/Get Command): \n  
																											* Used for setting or getting CCX configuration (RogueAP, CCKM, CKIP, All)\n
																											* Done Sync with no memory allocation\n 
																											* Parameter Number:	0x01	\n
																											* Module Number: CCX Manager Module Number \n
																											* Async Bit: OFF	\n
																											* Allocate Bit: OFF	\n
																											* GET Bit: ON	\n
																											* SET Bit: ON	\n
