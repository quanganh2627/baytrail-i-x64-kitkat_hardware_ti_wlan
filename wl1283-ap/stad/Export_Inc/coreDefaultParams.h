...
-----------------------------*/
#define CCX_MNGR_ENABLE_MIN             CCX_MODE_DISABLED
#define CCX_MNGR_ENABLE_MAX             CCX_MODE_STANDBY
#define CCX_MNGR_ENABLE_DEF             CCX_MODE_ENABLED

#define CCX_TEST_IGNORE_DEAUTH_0_DEF            1
#define CCX_TEST_IGNORE_DEAUTH_0_MIN            0
#define CCX_TEST_IGNORE_DEAUTH_0_MAX            1
