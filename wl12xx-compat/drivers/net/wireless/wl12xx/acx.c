...
int wl1271_acx_arp_ip_filter(struct wl1271 *wl, u8 enable, __be32 address)
{
	...
	wl1271_debug(DEBUG_ACX, "acx arp ip filter, enable: %d for %d.%d.%d.%d", enable,
...
int wl1271_acx_set_rx_data_filter(struct wl1271 *wl, u8 index, bool enable,				  					 struct wl12xx_rx_data_filter *filter)
